...
def main():
    ...
    ap.add_argument("--split_dir", type=str, default="runs/Cylinder/split_seq1_seed0_r0.8",
    ...
    # 模型
    ap.add_argument("--ckpt", type=str, default='runs/Cylinder/final.pt')
    ...
    # 其他
    ap.add_argument("--norm_path", type=str, default="runs/Cylinder/flow_mean_std.npy", help="训练时保存的 flow_mean_std.npy（推荐传入）")
